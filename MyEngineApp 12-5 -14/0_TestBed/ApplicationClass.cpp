...
void ApplicationClass::InitAppSystem(void)
{
	...
	m_pSystem->WindowName = "Bullet integration";
	m_pSystem->m_RenderingContext = OPENGL3X;
...
void ApplicationClass::InitAppInternalVariables()
{
	...
	m_pCamera->SetPosition(vector3( 0.0f, 5.0f, 15.0f ));
	...
	//pWorld = new btDiscreteDynamicsWorld(
}
...
void ApplicationClass::Display3X (void) //for OpenGL 3.X Applications
{
	...
	m_pModelMngr->RenderInstance(); //renders the instance list
